...
SystemInfo["HasMultiBoot"] = fileCheck("/media/mmc/STARTUP_1") and getMachineBuild() not in ('gb7252')
SystemInfo["HasMultiBootGB"] = SystemInfo["HasSwap"] and fileCheck("/media/mmc/STARTUP_1") and getMachineBuild() in ('gb7252')
